...
//M(Mask1/$85101//)
	...
	DEF VAR2=(I/1,2//$85105,$85105,,/WR3,,al1//"$R[4]"/10,90,170/180,90,80/,4);试切，加工

	DEF VAR3=(R///$85107,$85107,,/WR3,,al1//"$R[50]"/10,150,170/180,150,80/,4);工序1 x 起始位
	DEF VAR4=(R///$85108,$85108,,/WR3,,al1//"$R[51]"/10,170,170/180,170,80/,4);工序1 x 终止位
	DEF VAR5=(R///$85109,$85109,,/WR3,,al1//"$R[52]"/10,190,170/180,190,80/,4);工序1 x 变速位
	DEF VAR6=(R///$85110,$85110,,/WR3,,al1//"$R[60]"/10,220,170/180,220,80/,4);工序2 x 起始位
	DEF VAR7=(R///$85111,$85111,,/WR3,,al1//"$R[61]"/10,240,170/180,240,80/,4);工序2 x 终止位
	DEF VAR8=(R///$85112,$85112,,/WR3,,al1//"$R[62]"/10,260,170/180,260,80/,4);工序2 x 变速位
	...
	DEF VAR12=(I/1,//$85117,$85117,,/WR3,,al1//"$R[7]"/300,100,170/470,100,80/,4);起始加工槽
	DEF VAR13=(I/1,2//$85118,$85118,,/WR3,,al1//"$R[8]"/300,120,170/470,120,80/,4);最终加工工序号
