...
//M(Mask1/$85101//)
	...
	DEF VAR9=(I/0,2//$85106,$85106,,/WR3,,al1//"$R[223]"/10,80,110/120,80,80/,4);第3工序刀库号

	DEF MSG_3=(I///$85105,$85105,,/WR1,,al1///10,100,230/0,0,0/);MESSAGE
	DEF VAR2=(I/1,2//$85105,$85105,,/WR3,,al1//"$R[4]"/0,0,0/120,120,80/,4);试切，加工
	...
	DEF VAR36=(R///$85129,$85129,,/WR3,,al1//"$R[63]"/0,290,180/180,290,80/,4);工序3 x 起始位
	DEF VAR37=(R///$85130,$85130,,/WR3,,al1//"$R[64]"/0,310,180/180,310,80/,4);工序3 x 终止位
	DEF VAR38=(R///$85131,$85131,,/WR3,,al1//"$R[65]"/0,330,180/180,330,80/,4);工序3 x 变速位
	...
	DEF VAR11=(I/1,3//$85116,$85116,,/WR3,,al1//"$R[5]"/280,70,190/470,70,80/,4);起始加工工序
	DEF VAR13=(I/1,3//$85118,$85118,,/WR3,,al1//"$R[8]"/300,90,170/470,90,80/,4);最终加工工序号
	...
	DEF VAR29=(R////WR4//"/NC/_N_NC_GD2_ACX/X_POS_TOOL_START[4]"/0,0,0/0,0,0/);工序3 x 起始位
	DEF VAR30=(R////WR4//"/NC/_N_NC_GD2_ACX/X_POS_TOOL_END[4]"/0,0,0/0,0,0/);工序3 x 终止位
	DEF VAR31=(R////WR4//"/NC/_N_NC_GD2_ACX/X_POS_SPEED_CHANGE[4]"/0,0,0/0,0,0/);工序3 x 变速位
	...
	END_CHANGE
	CHANGE(VAR36)
		IF VAR29.VAL<>VAR36.VAL
			VAR29.VAL=VAR36.VAL
		ENDIF
	END_CHANGE
	CHANGE(VAR37)
		IF VAR30.VAL<>VAR37.VAL
			VAR30.VAL=VAR37.VAL
		ENDIF
	END_CHANGE
	CHANGE(VAR38)
		IF VAR31.VAL<>VAR38.VAL
			VAR31.VAL=VAR38.VAL
		ENDIF
	END_CHANGE
